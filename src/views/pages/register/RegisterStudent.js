...
const RegisterStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validasi form
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.classLevel || !formData.password || !formData.confirmPassword) {
  ...
  return (
    ...
    <div className="input-group">
      ...
      >
        <CIcon 
          icon={showPassword ? cilLowVision : cilViewStream} 
          size="lg"
        />
      </CButton>
    </div>
