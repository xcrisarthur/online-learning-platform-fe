...
const PreTest = () => {
  ...
  const handleChoiceModeChange = (e) => {
    ...
    if (mode === 'single') {
      ...
      setChoiceInputFields(Array(numChoiceFields).fill(''))
    }
  }
  ...
  const handleDirectAddQuestion = async () => {
    ...
    if (questionMode === 'single') {
      ...
      if (inputFields[0].trim() === '') {
        setShowEmptyInputWarningModal(true)
        return
      }
    ...
    <>
      ...
      <div>
        ...
        {userRole === 'student' && (
          <div className="mb-3">
            <h2>Hi, {username}</h2>
            <p>Selamat datang di bagian Pre-Test!</p>
            <p>
              Tes ini bertujuan untuk mengukur pemahaman awal Anda tentang materi yang akan
              dipelajari. Tidak perlu khawatir tentang hasilnya karena ini hanya untuk mengetahui
              sejauh mana pengetahuan Anda saat ini.
            </p>
            <p>
            ...
            <p>
              Kerjakan dengan jujur dan sebaik mungkin. Hasil tes ini akan membantu Anda mengenali
